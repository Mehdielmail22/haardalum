...
export const products: Product[] = [
  {
    ...
    dimensionsOptions: [
      { dimension: "3/8\" Diameter", price: 35.50 },
      { dimension: "1/2\" Diameter", price: 40.00 },
      { dimension: "5/8\" Diameter", price: 45.50 },
      { dimension: "3/4\" Diameter", price: 50.00 },
      { dimension: "1\" Diameter", price: 55.50 },
    ],
  },
  {
    id: 2,
    ...
    dimensionsOptions: [
      { dimension: "1\" x 1\" x 24\"", price: 42.00 },
      { dimension: "1\" x 1\" x 48\"", price: 58.00 },
      { dimension: "1\" x 1\" x 72\"", price: 75.00 },
    ],
  },
  {
    id: 3,
    ...
    dimensionsOptions: [
      { dimension: "2\" x 2\" x 0.2\" x 24\"", price: 28.75 },
      { dimension: "2\" x 2\" x 0.2\" x 48\"", price: 48.25 },
    ],
  },
  {
    id: 4,
    ...
    dimensionsOptions: [
      { dimension: "48\" Length", price: 75.00 },
      { dimension: "72\" Length", price: 110.00 },
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    dimensionsOptions: [
      { dimension: "12\" Length", price: 18.00 },
      { dimension: "24\" Length", price: 32.00 },
      { dimension: "36\" Length", price: 45.00 },
    ],
  },
  {
    id: 8,
    ...
    dimensionsOptions: [
      { dimension: "24\" Length", price: 29.95 },
      { dimension: "48\" Length", price: 52.50 },
      { dimension: "72\" Length", price: 78.00 },
    ],
  },
];
